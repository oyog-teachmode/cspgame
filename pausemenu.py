...
pygame.display.set_caption("CORNHUB PRODUCTIONS")
file = "assets/aba.mp3"
pygame.mixer.init()
...
def main_menu():
    while True:
        ...
        MENU_TEXT = get_font(100).render("MAIN MENU", True, (0, 0, 255))  # Blue color (RGB: 0, 0, 255)
        MENU_RECT = MENU_TEXT.get_rect(center=(640, 100))

        PLAY_BUTTON = Button(image=pygame.image.load("assets/Play Rect.png"), pos=(640, 400), 
                            text_input="LOAD", font=get_font(75), base_color=(215, 252, 212), hovering_color=(255, 255, 255))  # Light green color (RGB: 215, 252, 212), White color (RGB: 255, 255, 255)
        NEWGAME_BUTTON = Button(image=pygame.image.load("assets/Options Rect.png"), pos=(640, 275), 
                            text_input="NEWGAME", font=get_font(75), base_color=(215, 252, 212), hovering_color=(255, 255, 255))                    
        ...
        for button in [PLAY_BUTTON, OPTIONS_BUTTON, QUIT_BUTTON, NEWGAME_BUTTON]:
